          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                with excellent customer service and fast delivery worldwide.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/best-sellers" className="text-gray-300 hover:text-white transition-colors">Best Sellers</Link></li>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">support@e-shopping.com</span>
                </div>
              </div>
            </div>
          </div>
